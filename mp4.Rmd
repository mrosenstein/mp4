...
my_plot_911 <- my_data1 %>%
  ...
  labs(y = "Number of Cancelled Flights", x = "Airline",
...
=======
### Total Flights in September from 2001 to 2004
>>>>>>> 52a7c44c6969668fc1e53d1a6aeca4f1ea3cb88d
```{r}
my_plot_flights <- my_data2 %>%
  ...
  labs(title = "Total Flights to JFK Airports in Semptember in 2001, 2002, 2003, and 2004",
       y = "Number of Flights", x = "Date in September") +
  theme_bw()+
...
### September 2013 Total Flights Cancellation and Day-to-Day Weather Variation
```{r}
my_plot3 <- my_data3 %>%
  #filter(carrier == 'UA') %>%
  ggplot() +
...
=======
  ...
  labs(x = "Day in Semptember", y= "Total Flights Cancellation",
>>>>>>> 52a7c44c6969668fc1e53d1a6aeca4f1ea3cb88d
